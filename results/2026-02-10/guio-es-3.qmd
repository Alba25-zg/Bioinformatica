...
# Preparación
Usaremos los programas siguientes: instalar para mac homebrew y brew install para instalar
...
- [freebayes](https://github.com/freebayes/freebayes/releases) [@Garrison2012]. brew install freebayes, el segundo link y lo descomprimo y se lo meto en la carpeta bin
...
```
son lecturas cortas de bradyr no se que 
...
modificar nada en la carpeta. ¿Sabrías contar el número de líneas de cada archivo? poner gunzip -c dro... | wc y me dice el numero de lineas
:::
...
:::{.callout-note icon=false}
## Preguntas
- ¿Crees que deberíamos guardar los archivos descargados en `../../data`? no, porque son resultados de que hemos conseguido descargarlo, no hacen falta en data ocupando espacio
